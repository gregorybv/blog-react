...
export const SingleBlog = memo(({blog, user, comments}) => {
            ...
            <div className='blog-single-l'>
                <div className='blog-details'>
                    <div className='blog-info flex align-center'>
                        <div className='blog-info-item flex align-center'>
                            ...
                            <span
                                className='blog-info-item-text font-rubik fw-5'>{user?.firstName} {user?.lastName}</span>
                        </div>
                        <div className='blog-info-item flex align-center'>
                        ...
                        <div className='blog-tags-list flex align-center'>
                            {
                                blog?.tags?.map((tag, idx) => (
                                    <span className='blog-tags-item fs-13 font-rubik text-uppercase text-white ls-1'
                                          key={idx}>{tag}</span>
                                ))
                            }
                        </div>
                ...
                <div className='blog-author my-5'>
                    ...
                    <div className='blog-author-r'>
                        ...
                        <div
                            className='fs-16 fw-3 author-address'>Address: {user?.address?.address}, {user?.address?.city}</div>
                    </div>
                </div>
