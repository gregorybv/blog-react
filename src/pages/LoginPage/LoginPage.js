...
export const LoginPage = () => {
    ...
    const formDataHandler = useCallback((event, property) => {
                ...
                <div className='login-content'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='form-elem'>
                            ...
                            <input type="text" id="username" onChange={(e) => formDataHandler(e, "username")}
                        ...
                        <div className='form-elem'>
                            ...
                            <input type="password" id="password" onChange={(e) => formDataHandler(e, "password")}
